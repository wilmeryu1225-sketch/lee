...
typedef HANDLE(WINAPI* LCCREATEEX)(PLC_CONFIG, PPLC_CONFIG_ERRORINFO);
typedef VOID(WINAPI* LCREADSCATTER)(HANDLE, DWORD, PPMEM_SCATTER);
typedef VOID(WINAPI* LCWRITESCATTER)(HANDLE, DWORD, PPMEM_SCATTER);
typedef VOID(WINAPI* LCCLOSE)(HANDLE);
typedef BOOL(WINAPI* LCSETOPTION)(HANDLE, QWORD, QWORD);
typedef BOOL(WINAPI* LCGETOPTION)(HANDLE, QWORD, PQWORD);
typedef BOOL(WINAPI* LCCOMMAND)(HANDLE, QWORD, DWORD, PBYTE, PBYTE, PDWORD);
LCCREATEEX LcCreateEx;
LCREADSCATTER LcReadScatter;
LCWRITESCATTER LcWriteScatter;
LCCLOSE LcClose;
LCSETOPTION LcSetOption;
LCGETOPTION LcGetOption;
LCCOMMAND LcCommand;
/*
